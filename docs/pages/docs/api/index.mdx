...
| --- | --- | --- | --- |
| `initialData` | [`object`](/docs/api/initialData) | The initial data that Isoatlas will render. If `undefined`, isoatlas loads a blank scene. | `undefined` |
| `width` | `number` \| `string` | Width of the Isoatlas renderer as a CSS value. | `100%` |
| `height` | `number` \| `string` | Height of the Isoatlas renderer as a CSS value. | `100%` |
